...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows === 1) {
        ...
        $updateSql = "UPDATE admin SET otp = ? WHERE email = ?";
...
<body>
  ...
  <p>Thank you,<br />The Chai Junction Cafe Team</p>
            ...
            if ($mail->send()) {
                ...
                header('Location: adminpassverification.php?email=' . urlencode($userEmail));
                exit();
            } else {
...
<head>
    ...
    <title>Chai Junction - Login</title>
...
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <button class="sign-in send-otp">Send Otp</button>
        </form>
        <p class=" terms"><a href="adminLogin.html" class="terms">Back to Sign In</a></p>
    </div>
    <p class="footer">T&C © 2025 Chai Junction. All rights reserved.<br>Created by
        Sumit Srivastava<br>version -
        3.1.1</p>
</body>
